...
$(function(){
        ...
        var animation_end_pos = 3000; //where you want the animation to stop
        ...
        $(document).scroll(function() {
            ...
            if(scroll_pos >= animation_begin_pos && scroll_pos <= animation_end_pos ) { 
               // console.log( 'scrolling and animating' );
                ...
                $('section').animate({ backgroundColor: newColor }, 0);
            } else if ( scroll_pos > animation_end_pos ) {
                 $('section').animate({ backgroundColor: ending_color }, 0);
            } else if ( scroll_pos < animation_begin_pos ) {
                 $('section').animate({ backgroundColor: beginning_color }, 0);
            } else { }
        });
