<section class="bold font-light-orange vertical-center no-flicker min-padding veare-start" data-minpadding="50" data-minpadding-mobile="30">
	...
	<div class="section-content centered introduction">
		...
		<h1 class="veare-studio medium-headline">&amp; veare is my design studio.</h1>
	</div>
		...
		<div class="grid plus inline-block max-width-1200">
			<div class="span-5 tablet-span-6">
				...
				<div class="circle-copy copy font-black">
					...
					<p><strong>visionary design</strong> means creating a lasting design approach that grows with your company.
					</p>
					<p>A vision needs to be reevaluated and adjusted all the time and any design work needs to be flexible enough so it can evolve with your content and goals.
					</p>
				</div>
			</div>
...
<section class="light-blue last-block map no-flicker min-padding" data-minpadding="50" data-minpadding-mobile="30">
	<div class="vcard-wrapper">
		...
		<div class="contact-info top-line">
			...
			<div class="contact-item"><span class="label font-orange">P</span><a class="phone contact-link" href="tel:00491631626947" target="_blank">+49 163 162 69 47</a></div>
			<div  class="contact-item"><span class="label font-orange">M</span><a class="email contact-link" href="mailto:lukas@vea.re" target="_blank">lukas@vea.re</a></div>
		</div>
	</div>
	</div>
	<div class="pins">
